...
<a href="scoreboard.php" id="prvBtn"><i class="fa fa-long-arrow-left" aria-hidden="true"></i>&nbsp;이전게임으로</a>
...
<div class="totalWrap">
  ...
  <form id="nameForm" name="nameForm"  action="insert.php"  method="post" autocomplete="off" enctype="multipart/form-data"  onsubmit="return validateForm(this);">
    <div class="players">
